/-!
# p-adic-hodge-theory-canonical-lane Lean migration boundary
...
`PAdicHodgeTheoryCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "p-adic-hodge-theory-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/p-adic-hodge-theory-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for p-adic Hodge Theory: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["canonical-lane", "local-to-global", "manifold-constrained", "p-adic-hodge-theory", "galois-representations", "period-rings", "mathematical-proof", "reproducibility"]

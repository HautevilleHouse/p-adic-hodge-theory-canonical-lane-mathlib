# P Adic Hodge Theory — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/p-adic-hodge-theory-canonical-lane-mathlib.git
cd p-adic-hodge-theory-canonical-lane-mathlib
lake exe
lake build
```
